...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # A. The shovel operator modifies the String object rather than creating a new String object,costing memory.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised? nope.
    # A. First character of a string is [0] second is [1]
  end
